    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.pole_pos_offsets = np.array(
            [
                [-0.03, 0.0, 0.0],
                [-0.03+1*0.15/9, 0.0, 0.0],
                [-0.03+2*0.15/9, 0.0, 0.0],
                [-0.03+3*0.15/9, 0.0, 0.0],
                [-0.03+4*0.15/9, 0.0, 0.0],
                [-0.03+5*0.15/9, 0.0, 0.0],
                [-0.03+6*0.15/9, 0.0, 0.0],
                [-0.03+7*0.15/9, 0.0, 0.0],
                [-0.03+8*0.15/9, 0.0, 0.0],
                [0.12, 0.0, 0.0],
                [-0.03-1*0.15/9, 0.0, 0.0],
                [-0.03+10*0.15/9, 0.0, 0.0],
                [-0.03+11*0.15/9, 0.0, 0.0],
                [-0.03+4*0.15/9, 0.15/9, 0.0],
                [-0.03+4*0.15/9, -0.15/9, 0.0],
                [-0.03+5*0.15/9, 0.15/9, 0.0],
                [-0.03+5*0.15/9, -0.15/9, 0.0],
                [-0.03+12*0.15/9, 0.0, 0.0],
                [-0.03+13*0.15/9, 0.0, 0.0],
                [-0.03+14*0.15/9, 0.0, 0.0],
            ]
        )  # [m]
