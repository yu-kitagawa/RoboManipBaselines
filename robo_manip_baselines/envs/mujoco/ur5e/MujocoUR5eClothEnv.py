    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.pos_cloth_offsets = np.array(
            [
                [0.0, -0.12, 0.0],
                [0.0, -0.12+1*0.20/9, 0.0],
                [0.0, -0.12+2*0.20/9, 0.0],
                [0.0, -0.12+3*0.20/9, 0.0],
                [0.0, -0.12+4*0.20/9, 0.0],
                [0.0, -0.12+5*0.20/9, 0.0],
                [0.0, -0.12+6*0.20/9, 0.0],
                [0.0, -0.12+7*0.20/9, 0.0],
                [0.0, -0.12+8*0.20/9, 0.0],
                [0.0, 0.08, 0.0],
                [0.0, -0.12-1*0.20/9, 0.0],
                [0.0, -0.12-2*0.20/9, 0.0],
                [0.0, -0.12-3*0.20/9, 0.0],
                [0.20/9, -0.12+4*0.20/9, 0.0],
                [-0.20/9, -0.12+4*0.20/9, 0.0],
                [0.20/9, -0.12+5*0.20/9, 0.0],
                [-0.20/9, -0.12+5*0.20/9, 0.0],
                [0.0, -0.12+10*0.20/9, 0.0],
                [0.0, -0.12+11*0.20/9, 0.0],
                [0.0, -0.12+12*0.20/9, 0.0],
            ]
        )  # [m]
